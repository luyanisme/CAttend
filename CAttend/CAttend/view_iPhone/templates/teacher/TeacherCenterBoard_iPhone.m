...
#import "TeacherCenterBoardCell_iPhone.h"

#pragma mark -

@interface TeacherCenterBoard_iPhone()
{
	//<#@private var#>
}
@end

@implementation TeacherCenterBoard_iPhone
...
ON_CREATE_VIEWS( signal )
{
    ...
    self.list.whenReloading = ^{
        ...
        item.clazz = [TeacherCenterBoardCell_iPhone class];
...
ON_SIGNAL3(TeacherCenterBoardCell_iPhone, quit, signal){
