...
@interface LBXScanViewController : BeeUIBoard<UIImagePickerControllerDelegate,UINavigationControllerDelegate>
...
@property (nonatomic, copy) void (^whenAttend)();
...
AS_MODEL(AttendModel, attendModel)
