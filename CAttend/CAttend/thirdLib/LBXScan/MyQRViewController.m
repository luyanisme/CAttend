...
- (void)createQR1
{
    ...
    _tView.hidden = YES;
     ...
     UIImage *qrImg = [LBXScanWrapper createQRWithString:self.scheduleId size:_qrImgView.bounds.size];
...
- (void)createQR2
{
    ...
    UIImage *image = [LBXScanWrapper createQRWithString:self.scheduleId size:_qrImgView.bounds.size];
    //二维码上色
...
- (void)createQR3
{
    ...
    _qrImgView.image = [LBXScanWrapper createQRWithString:self.scheduleId
